...
{
    static PopupMenu MedidorPanel;
	static class MedidorPanel extends JPanel
		implements ChangeListener
	{
		...
		public MedidorPanel()
		{
			...
			JFreeChart jfreechart = createStandardDialChart("Medidor de temperatura", "°C", dataset, -40D, 60D, 10D, 4);
